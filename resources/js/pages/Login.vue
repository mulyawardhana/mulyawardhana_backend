    ...
    <div class="container">
        <div class="login-box">
            <div class="login-logo">
                <router-link :to="{ name: 'home' }"><b>BE</b>Mulya Wardhana</router-link>
            </div>
...
export default {
    ...
    methods: {
        ...
        ...mapActions('user', ['getUserLogin']), //MENGISIASI FUNGSI submit() DARI VUEX AGAR DAPAT DIGUNAKAN PADA COMPONENT TERKAIT. submit() BERASAL DARI ACTION PADA FOLDER STORES/auth.js
